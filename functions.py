...
def _protected_double(x1):
    """Closure of square root for negative arguments."""
    return x1*2

def _protected_half(x1):
    """Closure of square root for negative arguments."""
    return x1/2

def _protected_square(x1):
    """Closure of square root for negative arguments."""
...
e1= make_function(function=np.exp, name='exp', arity=1)
double=make_function(function=_protected_double, name='double', arity=1)
half=make_function(function=_protected_half, name='half', arity=1)
sqr=make_function(function=_protected_square, name='square', arity=1)
